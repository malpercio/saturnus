...
function parserFactory(options = {}){
  ...
  class Parser {
    ...
    prettify() {
      let readable =[];
      readable.push( this.minutes.partialPrettify("minute") );
      readable.push( this.hours.partialPrettify("hour") );
      readable.push( this.days.partialPrettify("day") );
      readable.push( this.months.partialPrettify("month") );
      readable.push( this.weekDays.partialPrettify("week day") );
      return "At " + readable.join(", ");
    }
